...
class BookDaoJdbcTest {
    ...
    void shouldCreateAndLoadCorrectBook() {
        ...
        var findBook = bookDao.getById(NEW_BOOK_ID);
        assertThat(findBook)
    ...
    Optional<Book> bookO = bookDao.getById(FIRST_BOOK_ID);
        bookO.ifPresent(value -> {
        value.setTitle(UPDATE_BOOK_NAME);
        bookDao.update(value);
    });
    var findBook = bookDao.getById(FIRST_BOOK_ID);
    assertThat(findBook)
    ...
    void shouldDeleteBookFromDbById() {
        ...
        var findBook = bookDao.getById(BOOK_ID_FOR_DELETE);
    ...
    void shouldFindExpectedBookById() {
        ...
        var actualBook = bookDao.getById(FIRST_BOOK_ID);
